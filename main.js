...
const traffic = [
  ...
  new Car(road.getLaneCenter(0), -990, 30, 50, "DUMMY", 2, getRandomColor()),
  new Car(road.getLaneCenter(1), -990, 30, 50, "DUMMY", 2, getRandomColor()),
  ...
  new Car(road.getLaneCenter(0), -1750, 30, 50, "DUMMY", 2, getRandomColor()),
